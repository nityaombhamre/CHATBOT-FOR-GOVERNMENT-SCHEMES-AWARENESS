  ...
  const schemesData = [
    {
      ...
      youtubeVideo: 'https://www.youtube.com/watch?v=PMKisan_Registration_Tutorial'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      youtubeVideo: 'https://www.youtube.com/watch?v=SukanyaSamriddhi_Account_Guide'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      detailedDescription: 'PMJAY provides cashless health insurance coverage of up to ₹5 lakh per family per year.',
    ...
    },
    {
      ...
      detailedDescription: 'PMUY provides LPG connections to women from Below Poverty Line households to promote clean and safe cooking practices.',
    ...
    
    {
      ...
      detailedDescription: 'APY provides a guaranteed monthly pension between ₹1,000 and ₹5,000 after the age of 60 to subscribers.',
    ...
    },
    {
      ...
      detailedDescription: 'SSY is a government-backed savings scheme offering high interest for the future education and marriage of girl children.',
    ...
    },
    {
      ...
      detailedDescription: 'Digital India aims to ensure government services are available electronically and digitally empower citizens.',
      eligibility: 'All Indian citizens',
      detailedEligibility: [
        'Indian citizen',
        'Access to mobile or internet'
      ],
    ...
    },
    {
      ...
      detailedDescription: 'MGNREGA guarantees at least 100 days of wage employment in a financial year to every rural household whose adult members volunteer to do unskilled manual work.',
    ...
    },
    {
      ...
      detailedDescription: 'NSP provides a centralized platform for application and disbursement of scholarships offered by the Central and State Governments.',
    ...
    },
    {
      ...
      detailedDescription: 'NSAP provides financial assistance to elderly persons, widows and persons with disabilities belonging to BPL households.',
    ...
    },
    {
      ...
      detailedDescription: 'Stand-Up India facilitates bank loans between ₹10 lakh and ₹1 crore to SC/ST and women entrepreneurs.',
    ...
    },
    {
      ...
      detailedDescription: 'Jal Jeevan Mission aims to provide safe and adequate drinking water through individual household tap connections.',
      eligibility: 'Rural households',
      detailedEligibility: [
        'Rural households',
    ...
    ,
    {
      ...
      detailedDescription: 'PM SVANidhi provides collateral-free working capital loans to street vendors to restart their businesses post-COVID and promote digital transactions.',
    ...
    },
    {
      ...
      detailedDescription: 'PMJDY aims to ensure access to financial services like banking, insurance and pension through basic savings bank accounts.',
      eligibility: 'All Indian citizens',
      detailedEligibility: [
        'Indian citizen',
        'Age 10+ years',
    ...
    },
    {
      ...
      detailedDescription: 'Pradhan Mantri Mudra Yojana provides collateral-free loans to micro and small enterprises to promote entrepreneurship and self-employment.',
    ...
    },
    {
      ...
      detailedDescription: 'Startup India promotes innovation and entrepreneurship through tax benefits, funding support and ease of doing business.',
    ...
    },
    {
      ...
      detailedDescription: 'Make in India aims to transform India into a global manufacturing hub by encouraging companies to manufacture locally.',
    ...
    },
    {
      ...
      detailedDescription: 'PMGKAY provides free food grains to beneficiaries under NFSA to ensure food security.',
      eligibility: 'NFSA beneficiaries',
      detailedEligibility: [
        'Ration card holders',
        'NFSA registered families'
      ],
    ...
    },
    {
      ...
      detailedDescription: 'ONORC allows beneficiaries to access subsidized food grains from any fair price shop across India.',
      eligibility: 'Ration card holders',
      detailedEligibility: [
        'NFSA beneficiaries',
        'Aadhaar linked ration card'
      ],
      benefits: 'Nationwide food access',
      detailedBenefits: [
        'Portability of ration',
